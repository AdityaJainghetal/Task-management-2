...
//         let api = "https://task-management-2-p6gu.onrender.com/admin/displaytaskuser";
...
//         let api = `https://task-management-2-p6gu.onrender.com/admin/deleteusertask/?id=${id}`;
...
//     const loadData = async () => {
//         try {
//             const response = await axios.get("https://task-management-2-p6gu.onrender.com/admin/displaytaskuser");
...
//             try {
//                 await axios.delete(`https://task-management-2-p6gu.onrender.com/admin/deleteusertask/?id=${id}`);
...
//         try {
//             setLoading(true);
//             await axios.put(`https://task-management-2-p6gu.onrender.com/admin/updatetask/${currentTask._id}`, currentTask);
...
//         setDeleting(true);
//         try {
//             await axios.delete(`https://task-management-2-p6gu.onrender.com/admin/deleteusertask`, {
//                 data: { id }
//             });
...
const DisplayTask = () => {
  ...
  const loadData = async () => {
    try {
      const response = await axios.get(
        "https://task-management-2-p6gu.onrender.com/admin/displaytaskuser"
      );
      setTasks(response.data);
    } catch (error) {
      console.error("Error loading tasks:", error);
  ...
  const deleteTask = async (id) => {
    if (window.confirm("Are you sure you want to delete this task?")) {
      ...
      try {
        await axios.delete(
          `https://task-management-2-p6gu.onrender.com/admin/deleteusertask`,
          {
            data: { id },
          }
        );
  ...
  const handleUpdateTask = async () => {
    try {
      setLoading(true);
      await axios.put(
        `https://task-management-2-p6gu.onrender.com/admin/updatetask/${currentTask._id}`,
        currentTask
      );
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="whitespace-pre-line">
                  {currentTask.taskdetail || "No description provided"}
                </p>
              </div>
